...
\begin{frame}{Roadmap of Presentation}
    \begin{itemize}
        \item \textbf{Setup \& Hypotheses:} Framing the "Tuition Coast" vs "Prestige" spatial boundaries.
        \item \textbf{Empirical Strategy:} Introducing the Spatial Difference-in-Discontinuities (DiDC) architecture.
        \item \textbf{Data \& Curation:} NBER TAXSIM microsimulations and MSE-optimal bandwidth engineering.
        \item \textbf{Results:} 
        \begin{itemize}
            \item Resolving the "Tuition Illusion".
            \item The 9.8\% Top 50 Prestige Capitalization premium.
        \end{itemize}
        \item \textbf{Event Study Validation:} Confirming the Efficient Market Hypothesis with flat pre-trends.
        \item \textbf{Caveats \& Conclusions.}
    \end{itemize}
\end{frame}
...
\begin{frame}{Visualizing Alphabetical Symmetry (CA vs AZ vs NV)}
    ...
    \begin{itemize}
        ...
        \item Unambiguously identifies the absolute spatial premium driven by amenity gaps.
    \end{itemize}
\end{frame}

% ---------------------------------------------------------
% 3. Background / Data / Bandwidth
% ---------------------------------------------------------
...
\begin{frame}{Methodology: Border Segmentation \& Bandwidth}
    \begin{itemize}
        \item \textbf{The Problem:} Comparing average state lines confounds climate and economy.  
        \item \textbf{Segmentation:} We fracture the entire US state-border network into discrete, evenly distributed segments ($\approx$ 50km bands). 
        ...
        \item This forces comparisons strictly between immediate cross-state neighbors operating in identical macroeconomic geographies, generating our highly curated 448k estimation pool.
    \end{itemize}
\end{frame}
        ...
        \resizebox{0.75\textwidth}{!}{
            \begin{tabular}{lcc}
                ...
                $\text{Effective Property Tax Rate}$ & & $-19.494^{***}$ \\
                 & & $(3.081)$ \\
                \midrule
                Income Tax / Macro Covariates &  & $\checkmark$ \\
                Fixed Effects & None & $\text{Seg\_ID} \times \text{Year}$ \\

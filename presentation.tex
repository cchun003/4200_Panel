...
\begin{frame}{Roadmap}
    \begin{itemize}
        ...
        \item \textbf{Data \& Curation:} NBER TAXSIM microsimulations and MSE-optimal bandwidth selection.
        \item \textbf{Results:} 
        \begin{itemize}
            \item Baseline
            \item Heterogeneity
...
\begin{frame}{Literature \& Contribution}
    \begin{itemize}
        ...
        \item \textbf{The Gap:} We know little about whether families sort at the \textit{state level} for higher education.
...
\begin{frame}{Data Sources \& Variable Construction}
    \begin{table}
        \centering
        \caption{Summary of Final Estimation Panel (2012--2024)}
        \resizebox{0.95\textwidth}{!}{
            \begin{tabular}{lll}
                \toprule
                \textbf{Variable Category} & \textbf{Data Source} & \textbf{Specific Variable Construction} \\
                \midrule
                Housing Costs & \textbf{Redfin} & Median Price Per SqFt (ZCTA level) \\
                Tuition & \textbf{IPEDS} & In-State Tuition weighted by enrollment \\
                Institution Caliber & \textbf{U.S. News} & Historical Ranking (Top 150 available) \\
                Income Tax & \textbf{NBER TAXSIM} & Simulated Federal \& State Liability\\
                Macro Controls & \textbf{BEA, BLS} & County/ZCTA Real GDP and Unemployment \\
                Local Policy & \textbf{ACS / TAXSIM} & Effective Property Tax Rates \\
                \bottomrule
            \end{tabular}
        }
    \end{table}
...
\begin{frame}{Visual Identification: The Prestige Discontinuity}
    \begin{center}
        \includegraphics[width=0.85\textwidth]{Output/rd_plot_prestige.pdf}
    \end{center}
    \begin{itemize}
